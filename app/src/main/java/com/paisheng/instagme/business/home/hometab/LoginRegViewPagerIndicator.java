package com.paisheng.instagme.business.home.hometab;
...
public class LoginRegViewPagerIndicator extends LinearLayout {
    /**
     * 绘制三角形的画笔
     */
     ...
     * 标题选中时的颜色
     */
    private static final int COLOR_TEXT_HIGHLIGHTCOLOR = 0xFFCC3333;

    public LoginRegViewPagerIndicator(Context context) {
        this(context, null);
    }

    public LoginRegViewPagerIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mPaint.setColor(Color.parseColor("#ffCC3333"));
    ...
    /**
     *<br> Description: 设置关联的ViewPager
     *<br> Author:      yuanbaining
     *<br> Date:        2018/1/25 11:38
     * @param mViewPager    关联的vp
     * @param pos           当前要显示页面
     */

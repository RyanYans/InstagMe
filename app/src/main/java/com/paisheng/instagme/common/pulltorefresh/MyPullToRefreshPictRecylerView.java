 ...
 * @date: 2017/8/3 11:10
 */
public class MyPullToRefreshPictRecylerView<T> extends PullToRefreshRecyclerView<T>
    ...
    public MyPullToRefreshPictRecylerView(Context context, OnPullListActionListener<T> mPullListActionListener) {
        super(context, mPullListActionListener);
        initData();
    }

    public MyPullToRefreshPictRecylerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initData();
    }

    public MyPullToRefreshPictRecylerView(Context context) {
        super(context);
        initData();
    }
